...
CUDA_VISIBLE_DEVICES=0 python run.py \
    ...
    --sgd_optim_layers "layers.16." "layers.17." "layers.18." "layers.19." "layers.20." "layers.21." "layers.22." "layers.23." "layers.24." "layers.25." "layers.26." "layers.27." "layers.28." "layers.29." "layers.30." "layers.31." "layers.32." "layers.33." "layers.34." "layers.35." "layers.36." "layers.37." "layers.38." "layers.39." \
