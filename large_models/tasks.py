...
class SST2Dataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        # data_dir = '/home/bld/data/glue/sst2_dataset'
...
class XSumDataset(Dataset):
    ...
    def load_dataset(self, **kwargs):
        ...
        d = load_from_disk('/data/peft_finetuning/data/summarization/xsum_dataset')
        train_d = d["train"]
        validation_d = d["validation"]
    ...
    def build_sample(self, example):
        ...
        id = example["id"]
        return Sample(id=id, data={"document": document, "summary": summary}, candidates=None,
                      correct_candidate=summary)  # Adjust Sample class accordingly

    def get_template(self, template_version=0):
        return {0: XSumTemplate}[template_version]()
